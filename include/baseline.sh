...
_stage_disks_unlink2() {
        printf '%s\n' "grep -vxF '$2' '$ELEBAKE_BASE/stage/$1/disks' > '$ELEBAKE_BASE/stage/$1/disks.new'; mv -f '$ELEBAKE_BASE/stage/$1/disks.new' '$ELEBAKE_BASE/stage/$1/disks'"
...
mv -f '$ELEBAKE_BASE/stage/$1/boot/loader.trust.conf.new' '$ELEBAKE_BASE/stage/$1/boot/loader.trust.conf' && chmod 0644 '$ELEBAKE_BASE/stage/$1/boot/loader.trust.conf'

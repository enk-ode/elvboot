...
TERMINAL_FUNCTIONS="_database_init0 _environment_init1 _environment_cache1 _setenv2 _getenv1 _unsetenv1 _cat1 _batch2 _printenv0 _unknown_command1 _error1 _error2 _error3 _fail2 _log1 _log2 _log3 _freebsd_prerequisites0 _help0 _help1 _help2 _help_env0 _help_env2 _last0 _last1 _openpgp_add2 _openpgp_add3 _openpgp_prerequisites0 _openpgp_import2 _pem_add3 _pem_prerequisites0 _pem_import2 _pkcs11_add3 _pkcs11_prerequisites0 _pkcs11_import2 _stage_list0 _stage_add1 _stage_sign_key3 _stage_attest_key3 _stage_unkey1 _stage_prerequisites1 _stage_status2 _stage_authenticode1 _stage_detachsign1 _stage_worktree2 _stage_clean_dir1 _stage_reset1 _stage_build_stand2 _stage_build_kernel1 _stage_install_kernel1 _stage_prerequisites_exist_add2 _stage_prerequisites_exist_drop2 _stage_prerequisites_exist_show1 _stage_prerequisites_verify_add2 _stage_prerequisites_verify_drop2 _stage_prerequisites_verify_show1 _stage_include2 _stage_filter_show2 _stage_install2 _stage_filter_show1 _stage_filter_add2 _stage_filter_drop2 _stage_include1 _stage_adopt4 _stage_loader2 _stage_manifest1 _stage_verify1 _stage_device4 _stage_backup2 _stage_deploy2 _stage_rollback3 _stage_trust_anchor1 _stage_trust_mk1 _stage_boot_tree4 _stage_tree_sync2 _stage_edit2 _stage_marker3 _stage_site_mk2 _stage_site_mk_report1 _stage_site_mk_report2 _stage_check_stage1 _stage_check_dir2 _stage_import_dir2 _stage_check_file3 _stage_import_file3 _stage_measure1 _stage_action1 _stage_when1 _stage_phase_show1 _stage_phase_show2 _stage_check_policy3 _stage_phase_policy_append3 _stage_phase_policy_append4 _stage_phase_policy_drop3 _expectation_add4 _expectation_drop1 _expectation_show0 _expectation_show1 _claim_add5 _claim_drop1 _claim_show0 _claim_show1 _trigger_add3 _trigger_drop1 _trigger_show0 _trigger_show1 _gate_add1 _gate_add2 _gate_drop1 _gate_claim_add2 _gate_claim_add3 _gate_claim_drop2 _gate_show0 _gate_show1 _policy_add2 _policy_drop1 _policy_trigger_add2 _policy_trigger_add3 _policy_trigger_drop2 _macro_add3 _macro_add4 _macro_add5 _macro_drop1 _macro_show0 _macro_show1 _stage_foundation_check1 _stage_foundation_make1 _stage_foundation_report1 _policy_show0 _policy_show1"
COMBINATOR_FUNCTIONS="__bootstrap1 __environment_cache0 __init0 __batch1 __restore1 __help_env1 __setintp2 __getintp1 __help_intp1 __help_intp2 __stage_device3 __stage_rollback2 __stage_marker2 __stage_prereqs_exist_add2 __stage_prereqs_verify_add2 __stage_prereqs_exist_drop2 __stage_prereqs_verify_drop2 __stage_prereqs_exist_show1 __stage_prereqs_verify_show1"
BATCH_COMBINATOR_FUNCTIONS="___bootstrap2 ___init1 ___dump_env1 ___dump0 ___batch0 ___openpgp_dump0 ___pem_dump0 ___pkcs11_dump0 ___prerequisites_verify0 ___stage_status1 ___stage_sign1 ___stage_attest1 ___stage_checkout2 ___stage_clean1 ___stage_build_stand1 ___stage_make1 ___stage_build1 ___stage_install1 ___stage_source1 ___stage_push2 ___stage_site_mk1 ___stage_dump0 ___stage_dump1 ___stage_dump_record1 ___stage_dump_marker1 ___stage_dump_backup1 ___stage_dump_boot1 ___stage_dump_rebuild1 ___stage_import2 ___stage_import3 ___stage_phase_policy_add3 ___stage_phase_policy_add4 ___foundation_dump0 ___stage_foundation1"
ANCHOR_FUNCTIONS="_database_init0 _environment_init1 _environment_cache1 _setenv2 _getenv1 _unsetenv1 _cat1 _batch2 _printenv0 _unknown_command1 _error1 _error2 _error3 _fail2 _log1 _log2 _log3 _freebsd_prerequisites0 _help0 _help1 _help2 _help_env0 _help_env2 _last0 _last1 _openpgp_add2 _openpgp_add3 _openpgp_prerequisites0 _openpgp_import2 _pem_add3 _pem_prerequisites0 _pem_import2 _pkcs11_add3 _pkcs11_prerequisites0 _pkcs11_import2 _stage_list0 _stage_add1 _stage_sign_key3 _stage_attest_key3 _stage_unkey1 _stage_prerequisites1 _stage_status2 _stage_authenticode1 _stage_detachsign1 _stage_worktree2 _stage_clean_dir1 _stage_reset1 _stage_build_stand2 _stage_build_kernel1 _stage_install_kernel1 _stage_prerequisites_exist_add2 _stage_prerequisites_exist_drop2 _stage_prerequisites_exist_show1 _stage_prerequisites_verify_add2 _stage_prerequisites_verify_drop2 _stage_prerequisites_verify_show1 _stage_include2 _stage_filter_show2 _stage_install2 _stage_filter_show1 _stage_filter_add2 _stage_filter_drop2 _stage_include1 _stage_adopt4 _stage_loader2 _stage_manifest1 _stage_verify1 _stage_device4 _stage_backup2 _stage_deploy2 _stage_rollback3 _stage_trust_anchor1 _stage_trust_mk1 _stage_boot_tree4 _stage_tree_sync2 _stage_edit2 _stage_marker3 _stage_site_mk2 _stage_site_mk_report1 _stage_site_mk_report2 _stage_check_stage1 _stage_check_dir2 _stage_import_dir2 _stage_check_file3 _stage_import_file3 _stage_measure1 _stage_action1 _stage_when1 _stage_phase_show1 _stage_phase_show2 _stage_check_policy3 _stage_phase_policy_append3 _stage_phase_policy_append4 _stage_phase_policy_drop3 _expectation_add4 _expectation_drop1 _expectation_show0 _expectation_show1 _claim_add5 _claim_drop1 _claim_show0 _claim_show1 _trigger_add3 _trigger_drop1 _trigger_show0 _trigger_show1 _gate_add1 _gate_add2 _gate_drop1 _gate_claim_add2 _gate_claim_add3 _gate_claim_drop2 _gate_show0 _gate_show1 _policy_add2 _policy_drop1 _policy_trigger_add2 _policy_trigger_add3 _policy_trigger_drop2 _policy_show0 _policy_show1 __bootstrap1 __environment_cache0 __init0 __batch1 __restore1 __help_env1 __setintp2 __getintp1 __help_intp1 __help_intp2 __stage_device3 __stage_rollback2 __stage_marker2 __stage_prereqs_exist_add2 __stage_prereqs_verify_add2 __stage_prereqs_exist_drop2 __stage_prereqs_verify_drop2 __stage_prereqs_exist_show1 __stage_prereqs_verify_show1 ___bootstrap2 ___init1 ___dump_env1 ___dump0 ___batch0 ___openpgp_dump0 ___pem_dump0 ___pkcs11_dump0 ___prerequisites_verify0 ___stage_status1 ___stage_sign1 ___stage_attest1 ___stage_checkout2 ___stage_clean1 ___stage_build_stand1 ___stage_make1 ___stage_build1 ___stage_install1 ___stage_source1 ___stage_push2 ___stage_site_mk1 ___stage_dump0 ___stage_dump1 ___stage_dump_record1 ___stage_dump_marker1 ___stage_dump_backup1 ___stage_dump_boot1 ___stage_dump_rebuild1 ___stage_import2 ___stage_import3 ___stage_phase_policy_add3 ___stage_phase_policy_add4 ___foundation_dump0 ___stage_foundation1"
...
FUNCTION_MODULES="__bootstrap1:database.sh ___bootstrap2:database.sh _database_init0:database.sh _environment_init1:database.sh __environment_cache0:database.sh _environment_cache1:database.sh ___init1:database.sh __init0:database.sh _setenv2:database.sh _getenv1:database.sh _unsetenv1:database.sh ___dump_env1:database.sh ___dump0:database.sh _cat1:database.sh ___batch0:database.sh __batch1:database.sh _batch2:database.sh __restore1:database.sh _printenv0:database.sh _freebsd_prerequisites0:freebsd.sh _help0:help.sh _help1:help.sh _help2:help.sh _help_env0:helpenv.sh __help_env1:helpenv.sh _help_env2:helpenv.sh _last0:inspect.sh _last1:inspect.sh __setintp2:intp.sh __getintp1:intp.sh __help_intp1:intp.sh __help_intp2:intp.sh _openpgp_add2:openpgp.sh _openpgp_add3:openpgp.sh _openpgp_prerequisites0:openpgp.sh ___openpgp_dump0:openpgp.sh _openpgp_import2:openpgp.sh _pem_add3:pem.sh _pem_prerequisites0:pem.sh ___pem_dump0:pem.sh _pem_import2:pem.sh _pkcs11_add3:pkcs11.sh _pkcs11_prerequisites0:pkcs11.sh ___pkcs11_dump0:pkcs11.sh _pkcs11_import2:pkcs11.sh ___prerequisites_verify0:prerequisites.sh _stage_list0:stage.sh _stage_add1:stage.sh _stage_sign_key3:stage.sh _stage_attest_key3:stage.sh _stage_unkey1:stage.sh _stage_prerequisites1:stage.sh ___stage_status1:stage.sh _stage_status2:stage.sh _stage_authenticode1:stage.sh _stage_detachsign1:stage.sh ___stage_sign1:stage.sh ___stage_attest1:stage.sh _stage_worktree2:stage.sh ___stage_checkout2:stage.sh _stage_clean_dir1:stage.sh _stage_reset1:stage.sh ___stage_clean1:stage.sh ___stage_build_stand1:stage.sh _stage_build_stand2 _stage_build_kernel1 _stage_install_kernel1:stage.sh _stage_prerequisites_exist_add2:stage.sh _stage_prerequisites_exist_drop2:stage.sh _stage_prerequisites_exist_show1:stage.sh _stage_prerequisites_verify_add2:stage.sh _stage_prerequisites_verify_drop2:stage.sh _stage_prerequisites_verify_show1:stage.sh __stage_prereqs_exist_add2:stage.sh __stage_prereqs_verify_add2:stage.sh __stage_prereqs_exist_drop2:stage.sh __stage_prereqs_verify_drop2:stage.sh __stage_prereqs_exist_show1:stage.sh __stage_prereqs_verify_show1:stage.sh _stage_include2:stage.sh _stage_filter_show2:stage.sh ___stage_make1:stage.sh ___stage_build1:stage.sh ___stage_install1:stage.sh _stage_install2:stage.sh _stage_filter_show1:stage.sh _stage_filter_add2:stage.sh _stage_filter_drop2:stage.sh _stage_include1:stage.sh _stage_adopt4:stage.sh _stage_loader2:stage.sh _stage_manifest1:stage.sh _stage_verify1:stage.sh __stage_device3:stage.sh _stage_device4:stage.sh _stage_backup2:stage.sh _stage_deploy2:stage.sh __stage_rollback2:stage.sh _stage_rollback3:stage.sh _stage_trust_anchor1:stage.sh _stage_trust_mk1:stage.sh ___stage_source1:stage.sh _stage_boot_tree4:stage.sh _stage_tree_sync2:stage.sh ___stage_push2:stage.sh _stage_edit2:stage.sh _stage_marker3:stage.sh __stage_marker2:stage.sh ___stage_site_mk1:stage.sh _stage_site_mk2:stage.sh _stage_site_mk_report1 _stage_site_mk_report1:stage.sh _stage_site_mk_report2:stage.sh ___stage_dump0:stage.sh ___stage_dump1:stage.sh ___stage_dump_record1:stage.sh ___stage_dump_marker1:stage.sh ___stage_dump_backup1:stage.sh ___stage_dump_boot1:stage.sh ___stage_dump_rebuild1:stage.sh ___stage_import2:stage.sh ___stage_import3:stage.sh _stage_check_stage1:stage.sh _stage_check_dir2:stage.sh _stage_import_dir2:stage.sh _stage_check_file3:stage.sh _stage_import_file3:stage.sh _stage_measure1:stage.sh _stage_action1:stage.sh _stage_when1:stage.sh _stage_phase_show1:stage.sh _stage_phase_show2:stage.sh _stage_check_policy3:stage.sh ___stage_phase_policy_add3:stage.sh ___stage_phase_policy_add4:stage.sh _stage_phase_policy_append3:stage.sh _stage_phase_policy_append4:stage.sh _stage_phase_policy_drop3:stage.sh _expectation_add4:foundation.sh _expectation_drop1:foundation.sh _expectation_show0:foundation.sh _expectation_show1:foundation.sh _claim_add5:foundation.sh _claim_drop1:foundation.sh _claim_show0:foundation.sh _claim_show1:foundation.sh _trigger_add3:foundation.sh _trigger_drop1:foundation.sh _trigger_show0:foundation.sh _trigger_show1:foundation.sh _gate_add1:foundation.sh _gate_add2:foundation.sh _gate_drop1:foundation.sh _gate_claim_add2:foundation.sh _gate_claim_add3:foundation.sh _gate_claim_drop2:foundation.sh _gate_show0:foundation.sh _gate_show1:foundation.sh _policy_add2:foundation.sh _policy_drop1:foundation.sh _policy_trigger_add2:foundation.sh _policy_trigger_add3:foundation.sh _policy_trigger_drop2:foundation.sh _policy_show0:foundation.sh _policy_show1:foundation.sh ___foundation_dump0:foundation.sh _macro_add3:foundation.sh _macro_add4:foundation.sh _macro_add5:foundation.sh _macro_drop1:foundation.sh _macro_show0:foundation.sh _macro_show1:foundation.sh _stage_foundation_check1:stage.sh _stage_foundation_make1:stage.sh _stage_foundation_report1:stage.sh ___stage_foundation1:stage.sh"
# === END AUTO-GENERATED ===
...
create_messy_realistic_database() {
  ...
  # backups of medium a (two generations)
  mkdir -p "$A/backup/a"
  echo old1 > "$A/backup/a/BOOTX64.EFI.20240101T000000Z"
  echo old2 > "$A/backup/a/BOOTX64.EFI.20250101T000000Z"
...
get_test_argument_variations() {
  ...
  case "$func" in
    ...
    # NVRAM write path -- NEVER exercised in tests
    stage_marker3|stage_marker2)
      echo "SKIP"; return ;;
    ...
    stage_adopt4)
      echo "alpha a testlabel zpool99/testds|beta a lbl pool/ds"; return ;;
    ...
    stage_rollback3)
      echo "alpha a BOOTX64.EFI.20250101T000000Z|alpha a nonexistent-backup"; return ;;
  esac
...
get_test_argument_by_database() {
  ...
  case "$func" in
    ...
    stage_reset1|stage_clean_dir1|stage_unkey1|stage_include1|stage_filter1)
      local names="" link
    ...
    stage_deploy2|stage_backup2|stage_tree_sync2)
...
#
READONLY_SKIP_FUNCTIONS="cat1 batch2 bootstrap2 init1 database_init0 environment_init1 environment_cache1 setenv2 unsetenv1 stage_add1 stage_sign_key3 stage_attest_key3 stage_unkey1 stage_filter2 stage_device4 stage_boot_tree4 stage_import2 stage_include1 stage_reset1 stage_clean_dir1 stage_worktree2 stage_edit2 stage_marker3 stage_site_mk2 stage_manifest1 stage_deploy2 stage_tree_sync2 stage_adopt4 stage_rollback3 stage_backup2 stage_build_stand2 stage_install2 pem_add3 openpgp_add2 openpgp_add3 pkcs11_add3"
